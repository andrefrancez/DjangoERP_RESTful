...
from companies.utils.permissions import EmployeePermissions, GroupPermissions
from companies.models import Employee, Enterprise
from companies.serializers import EmployeeSerializers, SpecificEmployeeSerializers
...
class EmployeeDetail(Base):
    ...
    def get(self, request, employee_id):
        ...
        serializer = SpecificEmployeeSerializers(employee)
    ...
    def put(self, request, employee_id):
        ...
        if email != employee.user.email and User.objects.filter(email=email).exists():
            raise APIException('This email is already in use', code='email_already_use')
    ...
    def delete(self, request, employee_id):
        ...
        if check_if_owner:
            raise APIException('You cannot fire the owner of the company')
